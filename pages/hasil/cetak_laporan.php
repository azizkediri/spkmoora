...
$no=1;
$sql = $koneksi ->query("select * from tabel_hasil JOIN tabel_alternatif ON tabel_hasil.list_alternatif = tabel_alternatif.list_alternatif ORDER BY tabel_hasil.nilai");
